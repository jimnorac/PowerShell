$array.clear() ;clear; Set-location -path "C:\_X\~PowerShell\CountOps_AD_Compare"  ; $splitter =""
$Outcsv = "C:\_X\~PowerShell\CountOps_AD_Compare__Split_User_Time_csv_out.xxx"
$Array = Import-csv -Path .\gusers-time.csv | Select-object *,@{Name='Accounts';Expression="."},@{Name='mailname';Expression="."},@{Name='N1';Expression="."},@{Name='N2';Expression="."},@{Name='N3';Expression="."}
...
clear
$Array | Select 'Traconid','Facility','Namefirst','N1','Namelast','N2','Email1','N3','mailname','Email2','Lastondate','Userid','Accounts'| export-csv -Path $Outcsv -Delimiter ";" -NoTypeInformation -Force 
